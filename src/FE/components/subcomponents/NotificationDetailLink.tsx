...
function NotificationDetailLink({i,e,length}:{i:any,e:any,length:number}) {
  ...
  return (
    ...
    }  key={i} id={(i==length-1)?'note_btn_first':(i==0)?'note_btn_last':""} className={`text-white/90 w-full ${e.opened?"bg-[#171C24]  ":"gradient_elements_div"} text-left bg-gray-700 hover:opacity-[0.9] px-6 py-8 block border-b border-gray-500`}>

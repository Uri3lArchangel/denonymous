...
function NotificationDetailLink({i,e}:{i:any,e:any}) {
  return (
    ...
    }} key={i} className={`text-white/90 w-full ${e.opened?"bg-[#171C24]  ":"gradient_elements_div"} text-left bg-gray-700  px-6 py-8 transform hover:scale-[1.02] transition duration-[0.3s]    block border-b border-gray-400`}>

...
function ActivateDenonyms({modal,setmodal,key_,e}:{modal:boolean,setmodal:React.Dispatch<React.SetStateAction<boolean>>,key_:string|undefined,e:denonymousType}) {
  return (

...
function ActivateDenonyms({modal,setmodal,key_,e,topic,setDisableState}:{modal:boolean,setmodal:React.Dispatch<React.SetStateAction<boolean>>,key_:string|undefined,e:denonymousType,topic:string,setDisableState:React.Dispatch<SetStateAction<boolean>>}) {
  return (
...
changeDenonymousViewState(key_!);
setmodal(false);
